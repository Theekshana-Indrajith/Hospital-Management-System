...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Welcome Header Background Image - Ward Theme */
        .welcome-header {
            position: relative;
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="/staff/wards">
...
<div class="container-fluid mt-4">
    ...
    <div class="welcome-header">
        <div class="row align-items-center">
            <div class="col-md-8">
                ...
                <p class="text-muted mb-0">Manage ward occupancy, bed allocation, and patient placement</p>
            </div>
            <div class="col-md-4 text-end">
                <div class="btn-group">
                    <a href="/staff/wards" class="btn btn-outline-light">
            ...
            <div class="card border-primary card-hover">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h5 class="card-title text-primary">Total Wards</h5>
                            <h2 class="text-primary">${wards.size()}</h2>
                            <p class="card-text text-muted">Active wards</p>
                        </div>
                        <div class="align-self-center">
                            <i class="fas fa-hospital fa-2x text-primary opacity-50"></i>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-success card-hover">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h5 class="card-title text-success">Total Beds</h5>
                            ...
                            <p class="card-text text-muted">All beds</p>
                        </div>
                        <div class="align-self-center">
                            <i class="fas fa-bed fa-2x text-success opacity-50"></i>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-warning card-hover">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h5 class="card-title text-warning">Occupied Beds</h5>
                            <h2 class="text-warning">
                                <c:set var="occupiedBeds" value="0" />
                                <c:forEach var="ward" items="${wards}">
                                    <c:set var="occupiedBeds" value="${occupiedBeds + (ward.totalBeds - ward.availableBeds)}" />
                                </c:forEach>
                                ${occupiedBeds}
                            </h2>
                            <p class="card-text text-muted">Currently occupied</p>
                        </div>
                        <div class="align-self-center">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-info card-hover">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h5 class="card-title text-info">Available Beds</h5>
                            <h2 class="text-info">
                            ...
                            <p class="card-text text-muted">Ready for admission</p>
                        </div>
                        <div class="align-self-center">
                            <i class="fas fa-procedures fa-2x text-info opacity-50"></i>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="card">
        <div class="card-header bg-light">
            <h5 class="mb-0">
                <i class="fas fa-hospital me-2 text-info"></i>Wards Overview
            </h5>
        </div>
        <div class="card-body">
            <div class="row">
                    ...
                    <div class="col-md-4 mb-4">
                        <div class="card border-success card-hover">
                            <div class="card-header bg-success text-white">
                                <h6 class="mb-0">
                                    <i class="fas fa-hospital me-2"></i>${ward.wardNumber} - ${ward.wardType}
                                </h6>
                            </div>
                            <div class="card-body">
                                <p class="card-text">${ward.description}</p>
                                <div class="ward-stats">
                                    <small>Total Beds: <strong>${ward.totalBeds}</strong></small><br>
                                    <small>Occupied: <strong>${ward.totalBeds - ward.availableBeds}</strong></small><br>
                                    <small>Available: <strong>${ward.availableBeds}</strong></small>
                                </div>
