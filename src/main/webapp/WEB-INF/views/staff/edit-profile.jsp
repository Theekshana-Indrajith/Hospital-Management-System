...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Welcome Header Background Image - Profile Edit Theme */
        .welcome-header {
            position: relative;
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <span class="navbar-text">
                        <i class="fas fa-user-nurse"></i>${username} (Nurse)
                    </span>
                </li>
                <li class="nav-item">
...
<div class="container-fluid mt-4">
    ...
    <div class="welcome-header">
        <div class="row align-items-center">
            ...
            <div class="col-md-4 text-end">
                <a href="/staff/profile" class="btn btn-outline-light">
    ...
    <form method="post" action="/staff/profile/update" id="profileForm" novalidate>
        <div class="row">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control" id="dateOfBirth" name="dateOfBirth"
                                       value="${staff.dateOfBirth}" max="">
                                <div class="invalid-feedback" id="dateOfBirthError">Please select a valid date of birth (must be at least 18 years old).</div>
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <select class="form-select" id="bloodGroup" name="bloodGroup">
                                    ...
                                    <option value="A+" ${staff.bloodGroup == 'A+' ? 'selected' : ''}>A+</option>
                                    <option value="A-" ${staff.bloodGroup == 'A-' ? 'selected' : ''}>A-</option>
                                    <option value="B+" ${staff.bloodGroup == 'B+' ? 'selected' : ''}>B+</option>
                                    <option value="B-" ${staff.bloodGroup == 'B-' ? 'selected' : ''}>B-</option>
                                    <option value="AB+" ${staff.bloodGroup == 'AB+' ? 'selected' : ''}>AB+</option>
                                    <option value="AB-" ${staff.bloodGroup == 'AB-' ? 'selected' : ''}>AB-</option>
                                    <option value="O+" ${staff.bloodGroup == 'O+' ? 'selected' : ''}>O+</option>
                                    <option value="O-" ${staff.bloodGroup == 'O-' ? 'selected' : ''}>O-</option>
                                </select>
                            </div>
                        </div>
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="allergies" name="allergies"
                                      rows="2" placeholder="List any allergies...">${staff.allergies}</textarea>
                        </div>
                        <div class="mb-3">
                            <label for="specialSkills" class="form-label">Special Skills</label>
                            <textarea class="form-control" id="specialSkills" name="specialSkills"
                                      rows="2" placeholder="List any special skills or certifications...">${staff.specialSkills}</textarea>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <input type="email" class="form-control" id="email" name="email"
                                   value="${staff.email}" placeholder="your.email@hospital.com">
                            <div class="invalid-feedback">Please provide a valid email address.</div>
                        </div>
                        <div class="mb-3">
                            <label for="contactNumber" class="form-label">Contact Number</label>
                            <input type="tel" class="form-control" id="contactNumber" name="contactNumber"
                                   value="${staff.contactNumber}" placeholder="+1 (555) 123-4567">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="emergencyContact" name="emergencyContact"
                                       value="${staff.emergencyContact}" placeholder="Full name">
                            </div>
                            <div class="col-md-6">
                                ...
                                <input type="tel" class="form-control" id="emergencyPhone" name="emergencyPhone"
                                       value="${staff.emergencyPhone}" placeholder="Emergency contact number">
                                <div class="invalid-feedback">Please provide a valid emergency phone number.</div>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="notes" name="notes"
                                      rows="4" placeholder="Any additional notes or information...">${staff.notes}</textarea>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="row mt-4">
            <div class="col-12 text-center">
                <button type="submit" class="btn btn-primary btn-lg me-3 quick-action-btn">
                    <i class="fas fa-save me-2"></i>Save Changes
                </button>
                <a href="/staff/profile" class="btn btn-outline-secondary btn-lg me-3 quick-action-btn">
                    <i class="fas fa-times me-2"></i>Cancel
                </a>
                <a href="/staff/dashboard" class="btn btn-outline-dark btn-lg quick-action-btn">
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        dateOfBirthInput.max = formattedMaxDate;

        // If current date of birth is in the future, clear it
        if (dateOfBirthInput.value && new Date(dateOfBirthInput.value) > maxDate) {
    ...
    document.getElementById('profileForm').addEventListener('submit', function(e) {
        ...
        if (contactNumber.value && !isValidPhone(contactNumber.value)) {
        ...
        if (emergencyPhone.value && !isValidPhone(emergencyPhone.value)) {
            emergencyPhone.classList.add('is-invalid');
            isValid = false;
        } else if (emergencyPhone.value) {
    ...
    function isValidPhone(phone) {
        // Basic phone validation - allows numbers, spaces, parentheses, and hyphens
