...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Welcome Header Background Image - Medical Theme */
        .welcome-header {
            position: relative;
        ...
        .info-card { border-left: 4px solid #0dcaf0; }
        .medical-card { border-left: 4px solid #198754; }
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="/staff/patients">
...
<div class="container-fluid mt-4">
    ...
    <div class="welcome-header">
        <div class="row align-items-center">
            <div class="col-md-8">
                ...
                <p class="text-muted mb-0">Complete patient information and medical history</p>
            </div>
    ...
    <!-- Rest of your existing patient details content remains exactly the same -->
    <div class="row">
        <!-- Patient Profile Sidebar -->
        <div class="col-lg-4 mb-4">
            <div class="card">
                <div class="card-body text-center">
                    <div class="profile-icon rounded-circle d-inline-flex align-items-center justify-content-center text-white mb-3">
                        <i class="fas fa-user fa-3x"></i>
                    </div>
                    <h4 class="text-info">${patient.firstName} ${patient.lastName}</h4>
                    ...
                    <div class="row text-center mb-3">
                        <div class="col-4">
                            <div class="text-primary">
                                <h5 class="mb-0">${not empty appointments ? appointments.size() : 0}</h5>
                                <small>Appointments</small>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="text-warning">
                                <h5 class="mb-0">${not empty prescriptions ? prescriptions.size() : 0}</h5>
                                <small>Prescriptions</small>
                            </div>
                        </div>
                        <div class="col-4">
                            <div class="text-success">
                                <h5 class="mb-0">${not empty labTests ? labTests.size() : 0}</h5>
                    ...
                    <div class="d-grid gap-2">
                        <c:if test="${not empty patient.contactNumber}">
                            <a href="tel:${patient.contactNumber}" class="btn btn-outline-primary">
        ...
        <!-- Patient Information Main Content -->
        <div class="col-lg-8">
            <!-- Navigation Tabs -->
            <ul class="nav nav-tabs mb-4" id="patientTabs" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="appointments-tab" data-bs-toggle="tab"
                        ...
                        <c:if test="${not empty appointments and appointments.size() > 0}">
                            <span class="badge bg-primary ms-1">${appointments.size()}</span>
                        </c:if>
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="prescriptions-tab" data-bs-toggle="tab"
                        ...
                        <c:if test="${not empty prescriptions and prescriptions.size() > 0}">
                            <span class="badge bg-warning ms-1">${prescriptions.size()}</span>
                        </c:if>
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link" id="labtests-tab" data-bs-toggle="tab"
                            ...
                            aria-controls="labtests" aria-selected="false">
                        <i class="fas fa-flask me-2"></i>Lab Tests
                        <c:if test="${not empty labTests and labTests.size() > 0}">
                            <span class="badge bg-success ms-1">${labTests.size()}</span>
                        </c:if>
                    </button>
                </li>
            </ul>
            ...
            <div class="tab-content" id="patientTabsContent">
                ...
                <div class="tab-pane fade show active" id="personal" role="tabpanel">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <table class="table table-borderless">
                                        ...
                                        <tr>
                                            <th>Date of Birth:</th>
                                            <td>${not empty patient.dateOfBirth ? patient.dateOfBirth : 'Not specified'}</td>
                                        </tr>
                                        <tr>
                                            <th>Gender:</th>
                                            <td>
                                                <span class="badge bg-info">${not empty patient.gender ? patient.gender : 'Not specified'}</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Age:</th>
                                    ...
                                    <table class="table table-borderless">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                ${not empty patient.contactNumber ? patient.contactNumber : 'Not specified'}
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Email:</th>
                                            <td>
                                                ...
                                                ${not empty patient.email ? patient.email : 'Not specified'}
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Address:</th>
                                            <td>
                                                ...
                                                ${not empty patient.address ? patient.address : 'Not specified'}
                                            </td>
                                        </tr>
                                        <tr>
                                            <th>Patient Since:</th>
                                            <td>
                                                <c:if test="${not empty lastAppointment}">
                                                    ${lastAppointment.appointmentDateTime.toLocalDate()}
                                                </c:if>
                                                <c:if test="${empty lastAppointment}">
                                                    New Patient
                                                </c:if>
                                            </td>
                                        </tr>
                    ...
                    <!-- Admission History -->
                    <div class="card mt-4 medical-card">
                        <div class="card-header bg-success text-white">
                            <h5 class="mb-0">
                                <i class="fas fa-history me-2"></i>Admission History
                            </h5>
                        </div>
                        <div class="card-body">
                            <c:choose>
                                <c:when test="${not empty admissions and admissions.size() > 0}">
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <c:forEach var="admission" items="${admissions}">
                                                <tr>
                                                    ...
                                                    <td>
                                                            <span class="badge
                                                                ${admission.status == 'ADMITTED' ? 'bg-success' :
                                                                  admission.status == 'DISCHARGED' ? 'bg-primary' : 'bg-warning'}">
                                                                    ${admission.status}
                                                            </span>
                                                    </td>
                                                </tr>
                ...
                <div class="tab-pane fade" id="prescriptions" role="tabpanel">
                    <div class="card">
                        <div class="card-body">
                            <c:choose>
                                <c:when test="${not empty prescriptions and prescriptions.size() > 0}">
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            <thead>
                                            <tr>
                                            ...
                                            <c:forEach var="prescription" items="${prescriptions}">
                                                <tr>
                                                    ...
                                                    <td>${prescription.prescriptionDate.toLocalDate()}</td>
                                                </tr>
                                            </c:forEach>
                                            </tbody>
                                        </table>
                ...
                <div class="tab-pane fade" id="labtests" role="tabpanel">
                    <div class="card">
                        <div class="card-body">
                            <c:choose>
                                <c:when test="${not empty labTests and labTests.size() > 0}">
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            <thead>
                                            <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge
                                                            ${test.status == 'COMPLETED' ? 'bg-success' :
                                                              test.status == 'IN_PROGRESS' ? 'bg-warning' : 'bg-secondary'}">
                                                                ${test.status}
                                                        </span>
                                                    </td>
...
<script>
    ...
    // Simple tab switching to ensure it works
