...
<html>
<head>
    <title>Patient Management - Staff</title>
    ...
    <style>
        ...
        * {
        ...
        /* Welcome Header Background Image - Patient Care Theme */
        .welcome-header {
            position: relative;
...
<div class="container-fluid mt-4">
    ...
    <div class="welcome-header">
        <div class="row align-items-center">
            <div class="col-md-8">
                ...
                <p class="text-muted mb-0">View and manage patient information with comprehensive care details</p>
            </div>
    ...
    <div class="card search-box text-white mb-4">
        <div class="card-body">
            <form id="searchForm" method="get" action="/staff/patients">
                <div class="row g-3">
                    <div class="col-md-8">
                        <div class="input-group input-group-lg">
                            ...
                            <input type="text" class="form-control" id="searchInput" name="search"
                                   placeholder="Search patients by name, contact number, or email..."
                                   value="${param.search}">
                        </div>
                    </div>
                    <div class="col-md-2">
                        <select class="form-select form-select-lg" id="statusFilter" name="status">
                            <option value="">All Status</option>
                            <option value="active" ${param.status == 'active' ? 'selected' : ''}>Active</option>
                            <option value="admitted" ${param.status == 'admitted' ? 'selected' : ''}>Admitted</option>
                            <option value="discharged" ${param.status == 'discharged' ? 'selected' : ''}>Discharged</option>
                        </select>
                    </div>
                    <div class="col-md-2">
    ...
    <div class="row">
        <c:forEach var="patient" items="${patients}">
            <div class="col-xl-4 col-lg-6 col-md-6 mb-4">
                <div class="card patient-card h-100 border-info">
                    <div class="card-header bg-info text-white">
                        <div class="d-flex justify-content-between align-items-center">
                            <h6 class="mb-0">
                                <i class="fas fa-user me-2"></i>Patient #${patient.id}
                            </h6>
                            <span class="badge bg-light text-info">ID: ${patient.id}</span>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <h5 class="card-title text-center text-info">${patient.firstName} ${patient.lastName}</h5>
                        ...
                        <div class="patient-info">
                            ...
                            <div class="mb-2">
                                ...
                                <span class="text-truncate">${patient.email}</span>
                            </div>
                            <div class="mb-2">
                            ...
                            <div>
                                ...
                                <small class="text-muted text-truncate">${patient.address}</small>
                            </div>
                        </div>
                    </div>
                    <div class="card-footer bg-transparent">
                        <div class="btn-group w-100">
                            <a href="/staff/patients/${patient.id}" class="btn btn-outline-info btn-sm">
                ...
                <div class="card text-center py-5">
                    <div class="card-body">
                        ...
                        <div class="alert alert-info">
                            ...
                            Patients are registered by receptionists and will appear here automatically.
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header bg-light">
                        <h6 class="mb-0">
                            <i class="fas fa-chart-bar me-2 text-info"></i>Patient Statistics
                        </h6>
                    </div>
                    <div class="card-body">
                        <div class="row text-center">
                            ...
                            <div class="col-md-3">
                                <div class="text-primary">
                                    <h3>
                                        <c:set var="activePatients" value="0"/>
                                        <!-- This would be calculated from service -->
                                            ${patients.size()}
                                    </h3>
