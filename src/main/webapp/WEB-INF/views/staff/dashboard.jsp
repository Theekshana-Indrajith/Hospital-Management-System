...
<html>
<head>
    <title>Staff Dashboard - HMS</title>
    ...
    <div class="welcome-header">
        <div class="row align-items-center">
            <div class="col-md-8">
                ...
                <p class="text-muted mb-0">Manage patient care, medication administration, and ward operations</p>
            </div>
            <div class="col-md-4 text-end">
                <div class="btn-group">
                    <a href="/staff/wards" class="btn btn-outline-light">
                        <i class="fas fa-bed me-2"></i>Wards Details
                    </a>
                    <a href="/staff/patients" class="btn btn-light">
                        <i class="fas fa-user-injured me-2"></i>Patient Care
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="card border-primary card-hover">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h5 class="card-title text-primary">Current Admissions</h5>
                            <h2 class="text-primary">${currentAdmissions}</h2>
                            <p class="card-text text-muted">Patients in care</p>
                        </div>
                        <div class="align-self-center">
                            <i class="fas fa-procedures fa-2x text-primary opacity-50"></i>
                        </div>
                    </div>
                    <div class="mt-2">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card border-success card-hover">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        <div>
                            <h5 class="card-title text-success">Available Beds</h5>
                            <h2 class="text-success">${availableBeds}</h2>
                    ...
                    <div class="mt-2">
                        <small class="text-muted">
                            <i class="fas fa-building me-1"></i>${totalBeds} total capacity
                        </small>
                    </div>
                </div>
            </div>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-light">
                    <h5 class="mb-0">
                        <i class="fas fa-tasks me-2 text-info"></i>Medical Operations
                    </h5>
                </div>
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-3 col-6">
                            <a href="/staff/wards" class="btn btn-outline-success w-100 h-100 py-3 quick-action-btn">
                                <i class="fas fa-bed fa-2x mb-2"></i><br>
                                <span>Ward Management</span>
                            </a>
                        </div>
                        <div class="col-md-3 col-6">
                            <a href="/staff/prescriptions" class="btn btn-outline-warning w-100 h-100 py-3 quick-action-btn">
                                <i class="fas fa-prescription fa-2x mb-2"></i><br>
                                <span>Prescriptions</span>
                            </a>
                        </div>
                        <div class="col-md-3 col-6">
                            <a href="/staff/schedule" class="btn btn-outline-primary w-100 h-100 py-3 quick-action-btn">
                                <i class="fas fa-calendar-alt fa-2x mb-2"></i><br>
                                <span>My Schedule</span>
                            </a>
                        </div>
                        <div class="col-md-3 col-6">
                            <a href="/staff/patients" class="btn btn-outline-info w-100 h-100 py-3 quick-action-btn">
