...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Page Header Background Image - Bed Management Theme */
        .page-header {
            position: relative;
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="/ward-manager/beds">
...
<div class="container mt-4">
    ...
    <div class="page-header mb-4">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h1 class="mb-1"><i class="fas fa-bed me-2"></i>Bed Management</h1>
                <p class="text-muted">Manage hospital beds, occupancy, and maintenance efficiently</p>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-header bg-info text-white d-flex justify-content-between align-items-center">
            <h5 class="mb-0"><i class="fas fa-procedures me-2"></i>Wards & Beds Overview</h5>
            <span class="badge bg-light text-info">${wards.size()} Wards</span>
        </div>
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-striped table-hover">
                    ...
                    <c:forEach var="ward" items="${wards}">
                        <tr>
                            <td>
                                <strong>${ward.wardNumber}</strong><br>
                                <small class="text-muted">${ward.description}</small>
                            </td>
                            <td>
                                <span class="badge
                                    <c:choose>
                            ...
                            <td>
                                ...
                                <c:forEach var="bed" items="${allBeds}">
                                    <c:if test="${bed.ward.id == ward.id && bed.status == 'MAINTENANCE'}">
                            ...
                            <td>
                                ...
                                <div class="progress" style="height: 20px;">
                                    <div class="progress-bar
                                        ...
                                        <fmt:formatNumber value="${occupancyRate}" pattern="0"/>%
                                    </div>
                                </div>
                            </td>
                            <td>
