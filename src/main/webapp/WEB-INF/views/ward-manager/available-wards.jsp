...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Page Header Background Image - Available Wards Theme */
        .page-header {
            position: relative;
            background-image: url('https://images.unsplash.com/photo-1519494026892-80bbd2d6fd0d?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1350&q=80');
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="/ward-manager/wards/available">
...
<div class="container mt-4">
    ...
    <div class="page-header mb-4">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h1 class="mb-1"><i class="fas fa-bed me-2"></i>Available Wards with Beds</h1>
                <p class="text-muted">Find available wards and beds for patient admissions</p>
            </div>
        </div>
    </div>
    ...
    <div class="row mb-4">
        <div class="col-md-4">
            <div class="card text-center">
                <div class="card-body">
                    <h5 class="card-title">Available Wards</h5>
        ...
        <div class="col-md-4">
            <div class="card text-center">
                <div class="card-body">
                    <h5 class="card-title">Overall Availability</h5>
                    <c:set var="totalBeds" value="0"/>
                    <c:forEach var="ward" items="${wards}">
                        <c:set var="totalBeds" value="${totalBeds + ward.totalBeds}"/>
                    </c:forEach>
                    <c:set var="availabilityRate" value="${totalBeds > 0 ? (totalAvailableBeds / totalBeds) * 100 : 0}"/>
                    <h3 class="text-info"><fmt:formatNumber value="${availabilityRate}" pattern="0.0"/>%</h3>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-header bg-success text-white">
            <h5 class="mb-0"><i class="fas fa-list me-2"></i>Wards with Available Beds</h5>
        </div>
        <div class="card-body">
            <c:if test="${empty wards}">
                <div class="alert alert-warning text-center">
                    ...
                    <a href="/ward-manager/wards" class="btn btn-primary mt-2">Manage Wards</a>
                </div>
            </c:if>
                        ...
                        <div class="col-md-6 mb-4">
                            <div class="card h-100 border-success">
                                <div class="card-header d-flex justify-content-between align-items-center bg-success text-white">
                                    ...
                                    <span class="badge bg-light text-success">${ward.availableBeds} beds available</span>
                                </div>
                                <div class="card-body">
                                    <p class="card-text">${ward.description}</p>
                                    <div class="ward-details">
                                        <small class="text-muted">
                                            <strong><i class="fas fa-building me-1"></i>Department:</strong> ${ward.department.name}<br>
                                            <strong><i class="fas fa-bed me-1"></i>Total Beds:</strong> ${ward.totalBeds}<br>
                                            <strong><i class="fas fa-money-bill me-1"></i>Charge per Day:</strong> Rs. <fmt:formatNumber value="${ward.chargePerDay}" pattern="0.00"/><br>
                                            <strong><i class="fas fa-chart-pie me-1"></i>Occupancy Rate:</strong>
                                ...
                                <div class="card-footer bg-transparent">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <a href="/ward-manager/beds/ward/${ward.id}" class="btn btn-sm btn-primary w-100">
                                                <i class="fas fa-bed me-1"></i>View Beds
                                            </a>
                                        </div>
                                    </div>
                                </div>
