...
<div class="container mt-4">
    ...
    <div class="welcome-header mb-4">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h2 class="mb-1">Good Evening, Dr. ${username}!</h2>
            ...
            <div class="col-md-4 text-end">
                <div class="btn-group">
                    ...
                    <a href="/prescriptions/add" class="btn btn-light">
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header bg-warning text-white">
                    <h5 class="mb-0"><i class="fas fa-user-friends me-2"></i>Quick Patient Management</h5>
                </div>
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-3">
                            <a href="/prescriptions/add" class="btn btn-outline-primary w-100 py-3">
                        ...
                        <div class="col-md-3">
                            <a href="/lab-tests/request" class="btn btn-outline-success w-100 py-3">
                                <i class="fas fa-flask fa-2x mb-2"></i><br>
                                <strong>Request Lab Test</strong><br>
                                <small class="text-muted">Order diagnostic tests</small>
                            </a>
                        </div>
                        <div class="col-md-3">
                            <a href="/doctor/patients" class="btn btn-outline-info w-100 py-3">
                        ...
                        <div class="col-md-3">
                            <a href="/doctor/admissions/admit" class="btn btn-outline-danger w-100 py-3">
                                <i class="fas fa-hospital-user fa-2x mb-2"></i><br>
                                    ...
                                    <div class="list-group-item">
                                        <div class="d-flex w-100 justify-content-between align-items-start">
                                            <div>
                                                ...
                                                <small>${appointment.appointmentDateTime}</small>
                                            </div>
                                            <div class="text-end">
        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0"><i class="fas fa-procedures me-2"></i>Recent Admissions</h5>
                </div>
                <div class="card-body">
                    <c:choose>
                        <c:when test="${not empty currentAdmissions}">
                            <div class="list-group list-group-flush">
                                <c:forEach var="admission" items="${currentAdmissions}" end="4">
                                    <div class="list-group-item">
                                        <div class="d-flex w-100 justify-content-between align-items-start">
                                            <div>
                                                <h6 class="mb-1">${admission.patient.firstName} ${admission.patient.lastName}</h6>
                                                <p class="mb-1 text-muted">${admission.diagnosis}</p>
                                                <small class="text-muted">
                                                    Ward: ${admission.ward.wardNumber} • Bed: ${admission.bed.bedNumber}
                                                </small>
                                            </div>
                                        ...
                                        <div class="mt-2">
                                            <small>Admitted: ${admission.admissionDate}</small>
                                        </div>
                                    </div>
                                </c:forEach>
                            </div>
                            <div class="text-center mt-3">
                                <a href="/doctor/admissions/manage" class="btn btn-primary btn-sm">View All Admissions</a>
                            </div>
                        </c:when>
                        <c:otherwise>
                            <div class="text-center py-4">
                                <i class="fas fa-procedures fa-2x text-muted mb-3"></i>
                                <p class="text-muted">No current admissions</p>
                                <a href="/doctor/admissions/admit" class="btn btn-primary btn-sm">Admit Patient</a>
                            </div>
                        </c:otherwise>
                    </c:choose>
                </div>
    ...
    <c:if test="${urgentCases > 0}">
        <div class="row mt-4">
            <div class="col-12">
                <div class="alert alert-danger">
                    <h6><i class="fas fa-bell me-2"></i>Urgent Attention Required</h6>
                    <p class="mb-0">You have ${urgentCases} cases requiring immediate attention.
                        <a href="/lab-tests/abnormal" class="alert-link">View abnormal results</a></p>
                </div>
            </div>
        </div>
    </c:if>
