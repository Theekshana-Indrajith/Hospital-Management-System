    ...
    <div class="welcome-header mb-4">
        <div class="row align-items-center">
            <div class="col-md-8">
                ...
                <p class="text-muted">Manage and view your patient records</p>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body border-bottom">
                    <div class="row">
                        <div class="col-md-6">
                            <form method="get" action="/doctor/patients" class="d-flex">
                                <div class="input-group">
                                    <input type="text" name="search" class="form-control" placeholder="Search patients by name..."
                                           value="${param.search}" aria-label="Search patients">
                        ...
                        <div class="col-md-6 text-end">
                            <small class="text-muted">
                                <c:if test="${not empty param.search}">
                                    Showing results for: "${param.search}"
                                </c:if>
                                <c:if test="${empty param.search}">
                                    Total patients: ${not empty patients ? patients.size() : 0}
                                </c:if>
                            </small>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <c:if test="${empty patients}">
                        <div class="alert alert-info text-center">
                            ...
                            <a href="/appointments/book" class="btn btn-primary">Add First Patient</a>
                        </div>
                    </c:if>
                            ...
                            <table class="table table-striped table-hover">
                                ...
                                <c:forEach var="patient" items="${patients}">
                                    <tr class="patient-card">
                                        ...
                                        <td>
                                            <c:choose>
                                                <c:when test="${not empty patient.contactNumber}">
...
<%--                                      --%>
                                        <td>
                                            <c:choose>
                                                <c:when test="${not empty patientAdmissionMap[patient.id]}">
                                                    <span class="badge bg-danger">Admitted</span>
                                                </c:when>
                                                <c:when test="${not empty patientAppointmentMap[patient.id]}">
                                        ...
                                        <td>
                                            <div class="btn-group" role="group">
                                                <a href="/doctor/patient/${patient.id}" class="btn btn-sm btn-info" title="View Details">
                                                    👁️ View
                                                </a>
                                            </div>
                                        </td>
