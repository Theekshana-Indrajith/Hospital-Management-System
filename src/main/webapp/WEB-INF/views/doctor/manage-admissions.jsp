...
<html>
<head>
    <title>Manage Admissions - HMS</title>
    ...
    <style>
        ...
        * {
        ...
        .welcome-header {
            position: relative;
            background-image: url('https://images.unsplash.com/photo-1586773860418-d37222d8fce3?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1350&q=80');
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="/doctor/admissions/manage">
...
<div class="container mt-4">
    ...
    <div class="welcome-header mb-4">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h2 class="mb-1"><i class="fas fa-procedures me-2"></i>Manage Admissions</h2>
                <p>Manage patient admissions and bed allocations</p>
            </div>
            <div class="col-md-4 text-end">
                <a href="/doctor/admissions/admit" class="btn btn-light">
                    <i class="fas fa-plus me-2"></i>Admit New Patient
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="card border-primary">
        <div class="card-header bg-primary text-white d-flex justify-content-between align-items-center">
            <h5 class="mb-0"><i class="fas fa-list me-2"></i>Current Admissions</h5>
            <span class="badge bg-light text-primary">${admissions.size()} patients</span>
        </div>
        <div class="card-body">
            <c:choose>
                        ...
                        <table class="table table-striped table-hover">
                            ...
                            <c:forEach var="admission" items="${admissions}">
                                <tr>
                                    ...
                                    <td>
                                        <span class="fw-bold">${admission.ward.wardNumber}</span><br>
                                    ...
                                    <td>
                                        <small>${admission.admissionDate.toLocalDate()}</small><br>
                                        ...
                                        <small class="text-muted">${duration.toDays()} days</small>
                                    </td>
                                    <td>
                                        <small>${admission.diagnosis}</small><br>
                                        <small class="text-muted">${admission.reason}</small>
                                    </td>
                                    <td>
                                            <span class="badge bg-${admission.severityLevel == 'CRITICAL' ? 'danger' :
                                                                   admission.severityLevel == 'SERIOUS' ? 'warning' : 'success'}">
                                                    ${admission.severityLevel}
                                            </span>
                                    </td>
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            <a href="/doctor/patient/${admission.patient.id}"
                                               class="btn btn-outline-primary" title="View Patient">
                                                <i class="fas fa-eye"></i>
                                            </a>
                                            <a href="/doctor/admissions/discharge/${admission.id}"
                                               class="btn btn-outline-success"
                                               onclick="return confirm('Discharge ${admission.patient.firstName} ${admission.patient.lastName}?')"
                                               title="Discharge">
                ...
                <c:otherwise>
                    <div class="text-center py-5">
                        ...
                        <p class="text-muted mb-4">You don't have any active patient admissions at the moment.</p>
                        <a href="/doctor/admissions/admit" class="btn btn-success btn-lg">
                            <i class="fas fa-plus me-2"></i>Admit First Patient
                        </a>
                    </div>
                </c:otherwise>
            </c:choose>
        ...
        <div class="col-12">
            <div class="card border-info">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-4">
                            <a href="/doctor/admissions/admit" class="btn btn-outline-success w-100 py-3">
                                <i class="fas fa-user-plus fa-2x mb-2"></i><br>
                                <strong>Admit Patient</strong><br>
                                <small class="text-muted">New admission</small>
                            </a>
                        </div>
                        <div class="col-md-4">
                            <a href="/doctor/patients" class="btn btn-outline-primary w-100 py-3">
                                <i class="fas fa-users fa-2x mb-2"></i><br>
                                <strong>All Patients</strong><br>
                                <small class="text-muted">View patient list</small>
                            </a>
                        </div>
                        <div class="col-md-4">
                            <a href="/prescriptions/add" class="btn btn-outline-warning w-100 py-3">
                                <i class="fas fa-prescription fa-2x mb-2"></i><br>
                                <strong>Add Prescription</strong><br>
                                <small class="text-muted">Prescribe medication</small>
                            </a>
                        </div>
                    </div>
                </div>
