...
<html>
<head>
    <title>Medical Staff Dashboard - HMS</title>
...
<nav class="navbar navbar-expand-lg">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link active" href="/medical-staff/dashboard">
...
<div class="container mt-4">
    ...
    <div class="page-header mb-4">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h1 class="mb-1"><i class="fas fa-user-md me-2"></i>Medical Staff & Department Management</h1>
                <p class="text-muted">Manage hospital staff, departments, and medical personnel</p>
            </div>
        </div>
    </div>
    ...
    <div class="row mt-4">
        ...
        <div class="col-md-3 mb-4">
            <div class="card text-center bg-warning text-white">
                <div class="card-body">
                    <h5><i class="fas fa-user-nurse"></i> Nurses</h5>
                    <h3>${nursesCount}</h3>
                </div>
            </div>
        </div>
        <div class="col-md-3 mb-4">
            <div class="card text-center bg-secondary text-white">
                <div class="card-body">
                    <h5><i class="fas fa-desktop"></i> Receptionists</h5>
                    <h3>${receptionistsCount}</h3>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="card mt-4">
        <div class="card-header">
            <h5><i class="fas fa-building me-2"></i>Departments Overview</h5>
        </div>
        <div class="card-body">
            <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    <strong>HOD:</strong> ${dept.headOfDepartment}<br>
                                    <strong>Doctors:</strong> ${dept.doctors.size()}
                                </p>
                                <a href="/medical-staff/departments" class="btn btn-sm btn-outline-primary">Manage</a>
                            </div>
                        </div>
                    </div>
                </c:forEach>
    ...
    <div class="row mt-4">
        <div class="col-md-4 mb-4">
            <div class="card text-center">
                <div class="card-body">
                    <h5><i class="fas fa-building"></i> Department Management</h5>
                    <p>Add, edit, and manage hospital departments</p>
                    <a href="/medical-staff/departments" class="btn btn-primary">Manage Departments</a>
                </div>
            </div>
        </div>
        <div class="col-md-4 mb-4">
            <div class="card text-center">
                <div class="card-body">
                    <h5><i class="fas fa-user-md"></i> Doctor Management</h5>
                    <p>Assign doctors to departments and manage shifts</p>
                    <a href="/medical-staff/doctors" class="btn btn-success">Manage Doctors</a>
                </div>
            </div>
        </div>
        <div class="col-md-4 mb-4">
            <div class="card text-center">
                <div class="card-body">
                    <h5><i class="fas fa-users"></i> Staff Management</h5>
                    <p>Manage nurses, receptionists, and other staff</p>
                    <a href="/medical-staff/staff" class="btn btn-info">Manage Staff</a>
                </div>
            </div>
        </div>
    </div>
