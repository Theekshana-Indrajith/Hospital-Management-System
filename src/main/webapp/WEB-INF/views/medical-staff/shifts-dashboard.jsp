...
<html>
<head>
    <title>Shift Management Dashboard - HMS</title>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="/medical-staff/shifts">
...
<div class="container mt-4">
    ...
    <div class="page-header mb-4">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h1 class="mb-1"><i class="fas fa-calendar-alt me-2"></i>Shift Management Dashboard</h1>
                <p class="text-muted">Manage hospital staff shifts, schedules, and ward assignments</p>
            </div>
        </div>
    </div>
    ...
    <!-- Ward List for Shift Management -->
    <div class="card mt-4">
        <div class="card-header">
            <h5 class="mb-0"><i class="fas fa-procedures me-2"></i>Manage Shifts by Ward</h5>
        </div>
        <div class="card-body">
            <div class="row">
                <c:if test="${not empty wards}">
                    <c:forEach var="ward" items="${wards}">
                        <div class="col-md-4 mb-3">
                            <div class="card ward-card h-100">
                                <div class="card-body text-center">
                                    <h6 class="card-title">${ward.wardNumber}</h6>
                                    <p class="small text-muted mb-1">${ward.wardType} Ward</p>
                                    <p class="small text-muted mb-2">
                                        <c:if test="${not empty ward.department}">
                                            ${ward.department.name}
                                        </c:if>
                                    </p>

                                    <div class="ward-info mb-3">
                                        <span class="badge bg-primary me-1">Beds: ${ward.totalBeds}</span>
                                    ...
                                    <div class="mt-3">
                                        <a href="/medical-staff/shifts/ward/${ward.id}" class="btn btn-primary btn-sm">
                                            <i class="fas fa-calendar me-1"></i>Manage Shifts
                                        </a>
                                    </div>
                                </div>
                            </div>
                ...
                <c:if test="${empty wards}">
                    <div class="col-12 text-center text-muted py-4">
                        ...
                        <p>No wards found. <a href="/wards">Create wards first</a> to manage shifts.</p>
                    </div>
                </c:if>
            </div>
        </div>
