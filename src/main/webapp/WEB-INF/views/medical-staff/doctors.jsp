    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="/medical-staff/doctors">
...
<div class="container mt-4">
    ...
    <div class="page-header mb-4">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h1 class="mb-1"><i class="fas fa-user-md me-2"></i>Doctor Department Assignment</h1>
                <p class="text-muted">Manage doctor assignments to departments and track department statistics</p>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0"><i class="fas fa-list me-2"></i>Doctor Assignments</h5>
        </div>
        <div class="card-body">
                        ...
                        <tr>
                            <td>
                                ...
                                <c:if test="${not empty doctor.roomNumber}">
                                    <br><small class="text-muted">Room: ${doctor.roomNumber}</small>
                                </c:if>
                            </td>
                            <td>
                            ...
                            <td>
                                <small>${doctor.contactNumber}</small><br>
                            ...
                            <td>
                                <form action="/medical-staff/doctors/assign-department" method="post" class="d-flex">
                                    <input type="hidden" name="doctorId" value="${doctor.id}">
                                    <select name="departmentId" class="form-control me-2" required>
                                        <option value="">Select Department</option>
                                        <c:forEach var="dept" items="${departments}">
                                            <option value="${dept.id}"
                                                    <c:if test="${doctor.department != null && doctor.department.id == dept.id}">selected</c:if>>
                                                    ${dept.name}
                                            </option>
                                        </c:forEach>
                                    </select>
            ...
            <div class="col-md-3 mb-3">
                <div class="card text-center">
                    <div class="card-body">
                        ...
                        <h3 class="text-primary">${dept.doctors.size()}</h3>
                        <p class="card-text small">Doctors Assigned</p>
                    </div>
                </div>
            </div>
        </c:forEach>
