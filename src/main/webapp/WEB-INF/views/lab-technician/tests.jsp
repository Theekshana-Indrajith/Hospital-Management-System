...
<html>
<head>
    <title>My Assigned Tests - HMS</title>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="/lab-technician/tests">
...
<div class="container mt-4">
    ...
    <div class="page-header mb-4">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h1 class="mb-1"><i class="fas fa-vial me-2"></i>My Assigned Tests</h1>
                <p class="text-muted">Manage and update your assigned laboratory tests</p>
            </div>
            <div class="col-md-4 text-end">
                <a href="/lab-technician/tests/pending" class="btn btn-warning">
                    <i class="fas fa-plus me-1"></i>Claim More Tests
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="card mt-4">
        <div class="card-header">
            <h5 class="mb-0"><i class="fas fa-list me-2"></i>Assigned Laboratory Tests</h5>
        </div>
        <div class="card-body">
            <c:choose>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-hover">
                            ...
                            <c:forEach var="test" items="${tests}">
                                <tr>
                                    <td>#${test.id}</td>
                                    <td>${test.patient.firstName} ${test.patient.lastName}</td>
                                    <td>${test.testName}</td>
                                    <td>
                ...
                <c:otherwise>
                    <div class="text-center py-4">
                        ...
                        <h4>No Tests Assigned</h4>
                        <p class="text-muted">You don't have any tests assigned to you yet.</p>
                        <a href="/lab-technician/tests/pending" class="btn btn-primary">
                            <i class="fas fa-plus me-1"></i>Claim Tests from Pending List
                        </a>
                    </div>
                </c:otherwise>
            </c:choose>
