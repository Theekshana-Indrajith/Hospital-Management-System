    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="/lab-technician/tests/pending">
...
<div class="container mt-4">
    ...
    <div class="page-header mb-4">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h1 class="mb-1"><i class="fas fa-clock me-2"></i>Pending Tests Available</h1>
                <p class="text-muted">Claim and assign tests to yourself for processing</p>
            </div>
            <div class="col-md-4 text-end">
                <a href="/lab-technician/tests" class="btn btn-primary">
                    <i class="fas fa-arrow-left me-1"></i>Back to My Tests
                </a>
            </div>
        </div>
    </div>
    ...
    <div class="card mt-4">
        <div class="card-header">
            <h5 class="mb-0"><i class="fas fa-tasks me-2"></i>Tests Available for Assignment</h5>
        </div>
        <div class="card-body">
            <c:choose>
...
<%--                                    <td>${test.doctor.name}</td>--%>
                                    ...
                                    <td>
                                        ...
                                        <c:if test="${empty test.description}">
                ...
                <c:otherwise>
                    <div class="text-center py-4">
                        ...
                        <p class="text-muted">All tests have been assigned to technicians.</p>
                        <a href="/lab-technician/tests" class="btn btn-primary">
                            <i class="fas fa-arrow-left me-1"></i>Back to My Tests
                        </a>
                    </div>
