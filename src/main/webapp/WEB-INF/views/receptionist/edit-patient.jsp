    ...
    <div class="welcome-header">
        <div class="row align-items-center">
            ...
            <div class="col-md-4 text-end">
                <a href="/receptionist/patients/${patient.id}" class="btn btn-outline-light">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="/receptionist/patients/update/${patient.id}" method="post" id="patientForm">
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control" name="dateOfBirth" id="dateOfBirth"
                                       value="${patient.dateOfBirth}" max="">
                                <div class="form-text">Birthday must be in previous years</div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div class="col-12">
                                <div class="d-flex justify-content-between">
                                    <a href="/receptionist/patients/${patient.id}" class="btn btn-secondary">
...
<script>
    // Set max date for birthday to yesterday (must be in previous years)
    ...
    // Form validation with birthday validation
    document.getElementById('patientForm').addEventListener('submit', function(e) {
        ...
        // Birthday validation - must be in previous years
        if (dateOfBirth) {
            ...
            if (birthDate >= today) {
                e.preventDefault();
                alert('Birthday must be in previous years. Please select a valid date of birth.');
                return;
            }
        }
    });
