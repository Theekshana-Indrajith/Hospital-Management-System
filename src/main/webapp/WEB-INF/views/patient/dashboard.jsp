...
<head>
    ...
    <style>
        ...
        * {
        ...
        /* Welcome Header Background Image - Matching Receptionist Style */
        .welcome-header {
            position: relative;
...
<div class="container-fluid mt-4">
    ...
    <div class="welcome-header">
        <div class="row align-items-center">
            <div class="col-md-8">
                <h1 class="mb-1">
                    <i class="fas fa-heartbeat me-2"></i>Welcome, ${patient.firstName}!
                </h1>
                <p class="lead mb-0">Here's your health overview and recent activities</p>
                <small>
            ...
            <div class="col-md-4 text-end">
                <div class="btn-group">
                    <a href="/patient/appointments" class="btn btn-outline-light">
                        <i class="fas fa-calendar-plus me-2"></i>Book Appointment
                    </a>
                    <a href="/patient/profile" class="btn btn-light">
    ...
    <div class="row">
        <div class="col-xl-3 col-md-6 mb-4">
            <a href="/patient/appointments" class="text-decoration-none">
                <div class="card border-primary card-hover">
                    <div class="card-body text-center">
                        ...
                        <small class="text-muted">
                            <c:choose>
                                <c:when test="${upcomingAppointments > 0}">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <a href="/patient/lab-tests" class="text-decoration-none">
                <div class="card border-success card-hover">
                    <div class="card-body text-center">
                        <div class="text-success mb-2">
                            <i class="fas fa-file-medical fa-2x"></i>
                        </div>
                        <h3 class="text-success">${labTestsCount}</h3>
                        <p class="card-text">Lab Tests</p>
                        <small class="text-muted">
                            <c:if test="${pendingLabResults > 0}">
                                ${pendingLabResults} pending results
                            </c:if>
                            <c:if test="${pendingLabResults == 0}">
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <a href="/patient/medical-records" class="text-decoration-none">
                <div class="card border-info card-hover">
                    <div class="card-body text-center">
                        <div class="text-info mb-2">
                            <i class="fas fa-prescription fa-2x"></i>
                        </div>
                        <h3 class="text-info">${activePrescriptions}</h3>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <a href="/patient/admissions" class="text-decoration-none">
                <div class="card border-warning card-hover">
                    <div class="card-body text-center">
                        <div class="text-warning mb-2">
                            <i class="fas fa-procedures fa-2x"></i>
                        </div>
                        <h3 class="text-warning">${admissionsCount}</h3>
                        <p class="card-text">Admissions</p>
                        <small class="text-muted">
                            <c:choose>
                                <c:when test="${not empty currentAdmissionStatus && currentAdmissionStatus != 'No current admission'}">
                                    Currently admitted
                                </c:when>
                                <c:otherwise>
    ...
    <!-- Health Reminders & System Status -->
    <div class="row mt-4">
        <div class="col-lg-8">
            <div class="card bg-light">
                <div class="card-body">
                    <h6 class="mb-3">
                        <i class="fas fa-heartbeat me-2 text-danger"></i>Health Reminders
                    </h6>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0 text-muted small">Take medications as prescribed by your doctor</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex align-items-center mb-3">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0 text-muted small">Arrive 15 minutes before scheduled time</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex align-items-center mb-3">
                                <i class="fas fa-running text-warning me-3 fa-lg"></i>
                                <div>
                                    <strong>Healthy Lifestyle</strong>
                                    <p class="mb-0 text-muted small">Regular exercise and balanced diet recommended</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="d-flex align-items-center mb-3">
                                <i class="fas fa-hand-holding-medical text-info me-3 fa-lg"></i>
                                <div>
                                    <strong>Follow-up Care</strong>
                                    <p class="mb-0 text-muted small">Attend all scheduled follow-up appointments</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="alert alert-warning">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        ...
                        <p class="mb-0">For medical emergencies, please call our emergency line: <strong>+1 (555) 123-HELP</strong> or visit the nearest emergency department.</p>
                    </div>
                </div>
            </div>
        </div>
